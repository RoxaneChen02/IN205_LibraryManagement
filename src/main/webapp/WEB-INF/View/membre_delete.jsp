...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Suppression du membre n°${id }</h5> 
        <div class="row">
          <p>Êtes-vous sûr de vouloir supprimer la fiche de ${prenom } ${nom } ?</p> 
	      <form action="/TP3Ensta/membre_delete" method="post" class="col s12">
	        ...
	        <div class="row center">
	          ...
	          <a class="btn waves-effect waves-light orange" href="/TP3Ensta/membre_details?id=${id }">Annuler</a> 
	        </div>
	      </form>
	    </div>	    
      </div>
