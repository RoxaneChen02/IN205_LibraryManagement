  ...
  <main>
    <section class="content">
      ...
      <h5>Détails du livre n°${id}</h5>
        <div class="row">
	      <form action="/TP3Ensta/livre_details?id=${id }" method="post" class="col s12"> <!-- TODO : remplacer idDuLivre par l'id du livre -->
	        <div class="row">
	          <div class="input-field col s12">
	            <input id="titre" type="text" value="${titre }" name="titre"> <!-- TODO : remplacer titreDuLivre par le titre du livre -->
	            <label for="titre">Titre</label>
	          </div>
	        </div>
	        <div class="row">
	          <div class="input-field col s6">
	            <input id="auteur" type="text" value="${auteur }" name="auteur"> <!-- TODO : remplacer auteurDuLivre par l'auteur du livre -->
	            <label for="auteur">Auteur</label>
	          </div>
	          <div class="input-field col s6">
	            <input id="isbn" type="text" value="${isbn}" name="isbn"> <!-- TODO : remplacer isbnDuLivre par l'isbn du livre -->
